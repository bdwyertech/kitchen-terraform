...
::Gem::Specification.new do |specification|
  ...
  specification.add_runtime_dependency "dry-validation", "~> 1.11"
  specification.add_runtime_dependency "inspec", "~> 5.21", "< 7.0"
  specification.add_runtime_dependency "json", "~> 2.7"
